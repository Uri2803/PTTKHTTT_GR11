  ...
  return (
    ...
    >
      ...
      >
        ...
        <Grid marginTop={2} marginBottom={2}>
          <FormControl sx={{ width:"100%", mt:"2"}} variant="outlined">
            ...
            <OutlinedInput 
              ...
              value={company ? company.JobDescription : ''}
              readOnly
            />
          </FormControl>
        </Grid>
        ...
        >
          <Button variant="contained" >Create Recruitment Registration</Button>
        </Box>
